...
import seedu.taskforge.commons.core.Version;
import seedu.taskforge.commons.exceptions.DataLoadingException;
import seedu.taskforge.commons.util.ConfigUtil;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        TaskForgeStorage taskForgeStorage = new JsonTaskForgeStorage(userPrefs.getAddressBookFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        Optional<ReadOnlyTaskForge> addressBookOptional;
