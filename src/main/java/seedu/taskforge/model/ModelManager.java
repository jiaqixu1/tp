...
public class ModelManager implements Model {
     ...
     */
    public ModelManager(ReadOnlyTaskForge addressBook, ReadOnlyUserPrefs userPrefs) {
        requireAllNonNull(addressBook, userPrefs);

        logger.fine("Initializing with address book: " + addressBook + " and user prefs " + userPrefs);

        this.taskForge = new TaskForge(addressBook);
    ...
    @Override
    public void setAddressBook(ReadOnlyTaskForge addressBook) {
        this.taskForge.resetData(addressBook);
    }

    @Override
    public ReadOnlyTaskForge getAddressBook() {
        return taskForge;
    }
