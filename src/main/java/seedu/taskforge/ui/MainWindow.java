...
public class MainWindow extends UiPart<Stage> {
     ...
     */
    void fillInnerParts() {
        personListPanel = new PersonListPanel(logic.getFilteredPersonList(), logic.getTaskForge());
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getTaskForgeFilePath());
     ...
     *
     * @see seedu.taskforge.logic.Logic#execute(String)
     */
