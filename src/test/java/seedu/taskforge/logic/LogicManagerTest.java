...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTaskForgeStorage addressBookStorage =
                new JsonTaskForgeStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonTaskForgeStorage addressBookStorage = new JsonTaskForgeStorage(prefPath) {
            @Override
            public void saveAddressBook(ReadOnlyTaskForge addressBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
