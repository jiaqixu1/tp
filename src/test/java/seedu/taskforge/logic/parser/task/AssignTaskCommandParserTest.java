...
public class AssignTaskCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + PROJECT_TASK_1, ParserUtil.MESSAGE_INVALID_INDEX);

        // zero index
        assertParseFailure(parser, "0" + PROJECT_TASK_1, ParserUtil.MESSAGE_INVALID_INDEX);
