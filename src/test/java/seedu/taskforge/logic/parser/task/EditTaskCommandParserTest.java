...
public class EditTaskCommandParserTest {
    ...
    public void parse_missingFields_failure() {
        ...
        assertParseFailure(parser, "1 " + PREFIX_INDEX + " 1", MESSAGE_INVALID_FORMAT);
    ...
    public void parse_duplicatePrefixes_failure() {
        assertParseFailure(parser, "1 " + PREFIX_INDEX + " 1" + TASK_DESC_IMPLEMENT_X + " -n another task",
                Messages.MESSAGE_DUPLICATE_FIELDS + PREFIX_NAME);
    }

    @Test
    public void parse_validArgs_success() {
        String userInput = INDEX_FIRST_PERSON.getOneBased() + " " + PREFIX_INDEX + " "
                + INDEX_FIRST_TASK.getOneBased() + TASK_DESC_IMPLEMENT_X;
